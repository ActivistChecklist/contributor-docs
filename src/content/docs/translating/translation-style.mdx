...
Please see the [English contributor style guide](/writing/style/) for the general principles of writing for Activist Checklist. These all apply to translations as well.

When translating, use your best judgment to apply the principles and guidelines in this guide. If you are not sure about something, [ask us for advice](https://activistchecklist.org/contact/).
...
"We use passphrases because they're easier to remember than random strings of characters."
</GoodBad>

<GoodBad tone="bad" type="blockquote">
"Users should employ passphrases to enhance credential security."
</GoodBad>
...
<GoodBad tone="good" type="blockquote">
"The cops can subpoena your messages from your provider."
</GoodBad>

<GoodBad tone="bad" type="blockquote">
"Law enforcement may legally request communications data from your service provider."
</GoodBad>
...
<GoodBad tone="good" type="blockquote">
"Signal uses end-to-end encryption, which means only you and the person you're talking to can read the messages."
</GoodBad>

<GoodBad tone="bad" type="blockquote">
"Signal uses strong security so your chats stay private."
</GoodBad>
...
- Prefer Latin American Spanish over general Spanish
- Use tú (not usted). Tú creates warmth, accessibility, and a sense of solidarity that fits an activist/organizing context. Usted can feel bureaucratic or distancing in this register, even where it is the regional default. Conjugate verbs and pronouns consistently in the tú form (e.g., tienes, tu cuenta, contigo).
- Choose language that is less bureaucratic. Plain language is the goal. Simplest synonyms are preferred.
- Prefer more concise and natural Spanish flow rather than matching the source English perfectly

<GoodBad tone="good" type="blockquote" title="Good (Latin American convention)">
"¿Puede apagar la ubicación antes de salir?"
</GoodBad>

<GoodBad tone="bad" type="blockquote" title="Not our style for this project">
"¿Puedes apagar la ubicación antes de salir?"
</GoodBad>
