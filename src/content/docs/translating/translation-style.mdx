...
This guide is a reference for translating Activist Checklist content. It is not a strict set of rules, but a guide to help you understand the context and tone of the content. The English voice, examples, and writing principles you are translating from are documented in the [Contributor style guide](/writing/style/).
